...
class PokemonTest {
    //LISTE DES TESTS A EFFECTUER :
        //Test des combats :
            ...
            //Stats des Pokémons Testés :
            //Pikachu -> attack:55,defense:40
            //Aquali -> attack:65,defense:60

            //1er Pokémon a meilleure attaque :
            @Test
            void premier_pokemon_devrait_gagner_car_meilleure_attaque() {
                // GIVEN
                //var premier = new Pokemon("Aquali", "urlImage", new Stats(65,60));
                //var second = new Pokemon("Pikachu", "urlImage2", new Stats(55,40));
